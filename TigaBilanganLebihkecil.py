...
if angka1 < angka2 and angka1 < angka3:
    print(angka1, "lebih kecil dari", angka2, "dan" ,angka3 )
elif angka2 < angka1 and angka2 < angka3:
    print(angka2, "lebih kecil dari", angka1, "dan", angka3)
elif angka3 < angka1 and angka3 < angka2:
    print(angka3, "lebih kecil dari", angka1, "dan", angka2)
    
elif angka1 == angka2 and angka1 and angka2 < angka3:
    print(angka1, "lebih kecil dari", angka3)
elif angka1 == angka3 and angka1 and angka3 < angka2:
    print(angka3, "lebih kecil dari", angka2)
elif angka2 == angka3 and angka2 and angka3 < angka1:
    print(angka2, "lebih kecil dari", angka1)
